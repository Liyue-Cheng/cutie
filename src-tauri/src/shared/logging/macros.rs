...
macro_rules! log_endpoint {
    ...
    (info, feature = $feature:expr, component = $component:expr, $($arg:tt)*) => {
        tracing::info!(
            target: &$crate::shared::logging::tags::endpoint_tag($feature, $component),
            $($arg)*
        )
    };
    // debug 级别
...
macro_rules! log_service {
    (info, feature = $feature:expr, component = $component:expr, $($arg:tt)*) => {
        tracing::info!(
            target: &$crate::shared::logging::tags::service_tag($feature, $component),
            $($arg)*
        )
    };
    (debug, feature = $feature:expr, component = $component:expr, $($arg:tt)*) => {
...
macro_rules! log_repository {
    (info, feature = $feature:expr, component = $component:expr, $($arg:tt)*) => {
        tracing::info!(
            target: &$crate::shared::logging::tags::repository_tag($feature, $component),
            $($arg)*
        )
    };
    (debug, feature = $feature:expr, component = $component:expr, $($arg:tt)*) => {
...
macro_rules! log_assembler {
    (info, feature = $feature:expr, component = $component:expr, $($arg:tt)*) => {
        tracing::info!(
            target: &$crate::shared::logging::tags::assembler_tag($feature, $component),
            $($arg)*
        )
    };
    (debug, feature = $feature:expr, component = $component:expr, $($arg:tt)*) => {
...
macro_rules! log_middleware {
    (info, component = $component:expr, $($arg:tt)*) => {
        tracing::info!(
            target: &$crate::shared::logging::tags::middleware_tag($component),
            $($arg)*
        )
    };
...
macro_rules! log_infra {
    (info, component = $component:expr, $($arg:tt)*) => {
        tracing::info!(
            target: &$crate::shared::logging::tags::infra_tag($component),
            $($arg)*
        )
    };
    (debug, component = $component:expr, $($arg:tt)*) => {
...
macro_rules! log_startup {
    (info, component = $component:expr, $($arg:tt)*) => {
        tracing::info!(
            target: &$crate::shared::logging::tags::startup_tag($component),
            $($arg)*
        )
    };
    (debug, component = $component:expr, $($arg:tt)*) => {
