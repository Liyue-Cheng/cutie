...
mod logic {
    ...
    pub async fn execute(
        ...
        // 6.1 填充 recurrence_expiry_behavior（使用 pool 查询，task_recurrences 表不在事务内修改）
...
mod database {
    use super::*;
    use crate::features::shared::repositories::TaskTimeBlockLinkRepository;
    use crate::features::shared::TimeBlockRepository;
