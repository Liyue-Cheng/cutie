...
use crate::{
    ...
    features::{
        recurrences::shared::{TaskRecurrenceLinkRepository, TaskRecurrenceRepository},
        shared::TransactionHelper,
        tasks::shared::repositories::{TaskRepository, TaskScheduleRepository},
    },
    shared::{
...
impl RecurrenceInstantiationService {
    ...
    fn date_matches_rrule(date: &NaiveDate, recurrence: &TaskRecurrence) -> AppResult<bool> {
        ...
        let dtstart_date = if let Some(ref start_date) = recurrence.start_date {
            ...
            crate::shared::core::utils::time_utils::format_date_yyyy_mm_dd(&created_date)
        };
